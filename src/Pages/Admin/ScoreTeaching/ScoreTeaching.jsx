...
const ScoreTeaching =() => {
  ...
  const handleScore = () => {
      ...
      let recommendation = document.getElementById("recommedation").value
      ...
      if(position === "prof"){
          if(score < 15 || score > 20){
            ...
            let type = []
            users.map((appraise)=> {
                if(appraise.documentType === "Teaching" && appraise.reviewID === reviewID){
            ...
            if(type == "Teaching"){
                Swal.fire({
                    title: 'Error',
                    text: 'Teaching Experience Document have been scored already',
                    icon: 'error',
                    confirmButtonText: 'Close'
                  })
            }else{
                addDoc(dbcollection, {score: score, documentType: "Teaching", ReviewID: reviewID, userID: id, Recommendation: recommendation})
                Swal.fire({
                    title: 'success',
