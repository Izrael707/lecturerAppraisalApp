...
const ViewTeachingExperienceDocument = () => {
    ...
    const imageListRef = ref(store, `${RewiewID}/Teaching/`)
       ...
       <div className="col-lg-2"></div>
           <div className="col-lg-8">
               <div>
                   ...
                   <h3>Uplaoded Teaching Experience Documment</h3>
...
export default ViewTeachingExperienceDocument